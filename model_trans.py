...
from model import VariationalAttentionModel, AudioDataset
...
resume_from_checkpoint = None #"checkpoints_trans/model_epoch_11800.pt"  # Change this to the checkpoint path if resuming
...
model = VariationalAttentionModel(input_dim=input_dim, sound_channels = 2, batch_size = batch_size, seq_len = 120000).to(device)
